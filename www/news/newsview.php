...
//news content
$strSQL = "select title,content,newsdate from newsinfo where id_newsinfo='".$_GET[newsid]."'  " ;
...
<div class="indexlist">
    ...
    <div style="text-align:center; color:#ccc; height:23px;line-height:23px;"><?=$onenews[newsdate];?></div>
